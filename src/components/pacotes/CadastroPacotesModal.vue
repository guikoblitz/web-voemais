<template>
    <q-dialog v-model="abrirCadastroPacotes" class="row items-center" persistent color="warning">
        <q-card style="min-width: 700px" class="background-color-modal no-scroll">
            ...
            <q-card class="q-pa-sm scroll background-color-modal" style="max-height: 70vh">
                <div class="row q-col-gutter-sm">
                    <div v-if="travel_package.image" style="height: 300px" class="col-12 col-md-12">
                        <q-img
                    ...
                    <div class="col-6 col-md-6">
                        ...
                        >
                            <template v-slot:append>
                                ...
                                >
                                    <q-tooltip anchor="center left" content-style="font-size: 12px" self="center right" :offset="[10, 10]">
                    ...
                    <div class="col-6 col-md-6">
                        ...
                        >
                            <template v-slot:append>
                                <q-icon v-if="!visualizePackage" name="search" class="cursor-pointer" @click="$refs.file.click()" />
                            </template>
                        </q-input>
                        <form :key="updateKeyForm" enctype="multipart/form-data">
                            <input ref="file" type="file" style="display: none" @input="buscarImagem()" />
                        </form>
                    </div>
                    <div class="col-6 col-md-6">
                        <q-input
                        ...
                        >
                            <template v-slot:append>
                                ...
                                <q-icon v-if="!visualizePackage" name="event" class="cursor-pointer" @click="limparDataFinal()">
                                    <q-popup-proxy
                                        @hide="isDataInicialSelecionada ? (isDataInicialFinalizada = true) : ''"
                    ...
                    <div class="col-6 col-md-6">
                        <q-tooltip
                            ...
                            :offset="[10, 10]"
                        >
                            <strong>Selecione uma Data Inicial para habilitar a edição</strong>
                        </q-tooltip>
                        <q-input
                            dense
                            outlined
