<template>
    <q-page class="background-color-page q-pa-md">
        <div class="row q-col-gutter-sm">
            ...
            >
                <div v-if="index === 0">
                    <q-img :src="getImgUrl(travelPackage.image)" class="image-banner" :ratio="16 / 9" position="50% 40%">
                        <div class="absolute-top-right row" style="background: none !important">
                            <div class="q-pr-xs">
                                <q-btn
                                    v-if="validateEmployee()"
                                    dense
                                    round
                                    color="yellow-8"
                                    icon="edit"
        ...
        <q-page-sticky v-if="validateEmployee()" position="bottom-right" :offset="[18, 18]">
